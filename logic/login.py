...
header = Headers(browser='firefox', os='lin')
...
login_payload_user = {'user_id': user_id, 'access_key': access_key}
...
def login_process():
    login_index = session.post(index_url,
                               ...
                               headers=headers)
    login_script = session.post(login_user_url,
                                data=login_payload_user,
                                headers=headers)
